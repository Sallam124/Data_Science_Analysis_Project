...
#dup_free_df.sort_values(by='Name', inplace=True)
#dup_free_df.sort_values(by='Platform', inplace=True)
dup_free_df.sort_values(by='Global_Sales_Millions', inplace=True, ascending=False)
#dup_free_df.sort_values(by='EU_Sales_Millions', inplace=True, ascending=False)
#dup_free_df.sort_values(by='NA_Sales_Millions', inplace=True, ascending=False)
#dup_free_df.sort_values(by='Publisher', inplace=True)
